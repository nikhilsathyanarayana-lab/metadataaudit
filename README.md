...
- View 3 (`SPA/js/3.js`) hydrates all four metadata tables (Visitor, Account, Custom, and Salesforce) with the same SubID, app name, and app ID rows discovered during app name lookups so each dataset starts from a consistent base list.
